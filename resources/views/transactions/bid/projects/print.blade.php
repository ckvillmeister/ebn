    ...
    <div class="print-page">
        {{-- DYNAMIC PAGE CONTENT --}}
            ...
            @elseif($page->page_name == "Bid Securing Declaration")
                ...
                IN WITNESS WHEREOF, I/We have hereunto set my/our hand/s this <b>{{ date('jS') }}</b> day of <b>{{ date('F Y') }}</b> at Talibon, Bohol.
                <br><br><br><br>
            ...
            @elseif($page->page_name == "Omnibus Sworn Statement")
                ...
                <p style="text-align: justify;">8. EBN Enterprises is aware of and has undertaken the responsibilities as a Bidder in compliance with the Philippine Bidding Documents, which includes:<br>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;b. Acknowledging all conditions, local or otherwise, affecting the implementation of the Contract;<br><br><br><br><br><br><br><br><br>
            ...
            @elseif($page->page_name == "Organizational Chart")
                <style>
                    .image-container {
                        ...
                        .overlay-text {
                        position: absolute; /* This lifts the text "above" the image */
                        bottom: 86%; /* Distance from the bottom */
                        left: 47%;   /* Distance from the left */
                        color: black;
                        padding: 10px;
                        border-radius: 5px;
                        }
                        ...
                        @if (count($attachment->defaultUploads) > 0)
                            ...
                            @foreach ($attachment->defaultUploads as $upload)
                                <div class="image-container">
                                    <img class="attachments" src="{{ asset($upload->image_url) }}">
                                    <div class="overlay-text"><b>{{ $project->project_name ?? '' }}</b></div>
                                </div>
                                @if ($attach_ctr < count($attachment->defaultUploads))
                                </div>
                                <div class="print-page">
                        ...
                        @if (count($attachment->defaultUploads) > 0)
                            ...
                            @foreach ($attachment->defaultUploads as $upload)
                                ...
                                @if ($attach_ctr == count($attachment->defaultUploads))
                                    <div class="row text-center">
                                        <div class="col-12">
                                            <img class="attachments" src="{{ asset($upload->image_url) }}" style="width: 87%; !important">
                                        </div>
                                    </div>
                                @else
                                    <img class="attachments" src="{{ asset($upload->image_url) }}">
            ...
            @elseif($page->page_name == "Warranty and Price Validity")
                ...
                In connection with our submitted bid for the Purchase of Fire Extinguisher, Calape, Bohol,
                ...
                remain valid and binding for a period of Fifteen (15) calendar days from the date of bid
                ...
                We further certify that all Fire Extinguishers to be supplied are brand new, unused, and
                ...
                We hereby guarantee that all supplied Fire Extinguishers are covered by a minimum warranty
                period of Six (6) Month from the date of delivery and acceptance by the procuring entity.
