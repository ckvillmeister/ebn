<div class="row">
    <div class="col-sm-4">
        <h6 class="text-secondary"><i class="fas fa-copyright mr-2"></i><em>Sales Transaction Code:</em></h6>
    </div>
    <div class="col-sm-5">
...
<div class="row">
    <div class="col-sm-4">
        <h6 class="text-secondary"><i class="fas fa-calendar-alt mr-2"></i><em>Date of Transaction:</em></h6>
    </div>
    <div class="col-sm-5">
        <b>{{ date('F d, Y', strtotime($transaction->transaction_date)) ?? '' }}</b>
    </div>
</div>
<div class="row">
    <div class="col-sm-4">
...
<div class="row mt-4">
    <div class="col-sm-12">
        &nbsp;<label><b><em>List of Products Sold</em></b></label>
