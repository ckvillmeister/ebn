    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Attachment Types
                <div class="page-title-subheading">Manager for types of attachments
                </div>
            </div>
        </div>    
    </div>
...
<script>
    ...
    $('body').on('click', '.btn-new', function(){
        attachmentTypeCreate(0);
    });

    $('body').on('click', '.btn-edit', function(){
        var id = $(this).val();
        attachmentTypeCreate(id);
    });
    ...
    $('body').on('click', '.btn-trash', function(){
        getAttachmentTypes(0);
    });

    function attachmentTypeCreate(id){
        $.ajax({
            headers: {
    ...
    function getAttachmentTypes(status){
        $.ajax({
            headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
